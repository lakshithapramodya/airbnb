...
function Footer() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 py-16 px-28 bg-gray-200">
      <div className="pb-8">
        <h2 className="font-bold text-xs font-sans mb-4 cursor-pointer">ABOUT</h2>
      ...
      <div className="pb-8">
        <h2 className="font-bold text-xs font-sans mb-4 cursor-pointer">SUPPORT</h2>
