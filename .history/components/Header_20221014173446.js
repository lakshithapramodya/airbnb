...
function Header() {
  return (
    <div className="sticky top-0  z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/* Right */}
      <div className="flex items-center mx-auto pl-2 ml-2 space-x-4 justify-end">
        <div className="flex rounded-full hover:bg-gray-50 px-4">
          <p className="text-sm font-semibold cursor-pointer">Become a Host</p>
        </div>
        <div className="rounded-full p-2 hover:bg-gray-50">
          <GlobeAltIcon className="h-5 text-gray-600" />
        </div>

        <div className="flex items-center border rounded-full p-1 space-x-2 shadow-sm px-2 hover:shadow-md">
