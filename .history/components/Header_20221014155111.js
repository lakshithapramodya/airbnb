...
function Header() {
  return (
    <div className="sticky top-0  z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/* Right */}
      <div className="my-auto flex items-center mx-auto pl-5 gap-4">
        <p className="text-sm font-semibold items-start">Become a Host</p>
        <GlobeAltIcon className="h-5 text-gray-600" />
        <div className="flex items-center border-2 rounded-full p-1 px-2 gap-2">
