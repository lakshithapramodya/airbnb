...
function Header() {
  return (
    <div className="sticky top-0  z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      {/* Left */}
      <div className="relative flex item-center h-10 cursor-pointer my-auto md:hidden sm:hidden lg:inline-flex">
        <Image
      ...
      <div className="relative flex item-center h-10 cursor-pointer my-auto lg:hidden">
        <Image
          src="https://cdn.iconscout.com/icon/free/png-256/social-258-116292.png"
          layout="fill"
          objectFit="contain"
          objectPosition="left"
        />
      ...
      <div className="my-auto flex items-center mx-auto pl-4 gap-4">
        ...
        <div className="flex items-center border rounded-full p-1 gap-2 shadow-sm px-2">
