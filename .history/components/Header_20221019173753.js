...
function Header({ placeholder }) {
  ...
  return (
    ...
    >
      ...
      <div
        onClick={() => router.push("/")}
        className="relative flex item-center h-12 cursor-pointer my-auto"
      >
        <Image
      ...
      >
        <input
          ...
          md:min-w-0  text-sm text-gray-600 placeholder:text-xs md:placeholder:text-sm"
          type="text"
        ...
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div>
            ...
            <div className="flex mt-4">
              ...
              <button onClick={search} className="text-red-500 flex-grow">
                Search
              </button>
            </div>
          </div>
